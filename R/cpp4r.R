...
sendWSMessage <- function(conn, binary, message) {
	invisible(.Call(`_tinyhttpserver_sendWSMessage`, conn, binary, message))
}

closeWS <- function(conn, code, reason) {
	invisible(.Call(`_tinyhttpserver_closeWS`, conn, code, reason))
}
...
makeTcpServer <- function(host, port, onHeaders, onBodyData, onRequest, onWSOpen, onWSMessage, onWSClose, staticPaths, staticPathOptions, quiet) {
	.Call(`_tinyhttpserver_makeTcpServer`, host, port, onHeaders, onBodyData, onRequest, onWSOpen, onWSMessage, onWSClose, staticPaths, staticPathOptions, quiet)
}
...
makePipeServer <- function(name, mask, onHeaders, onBodyData, onRequest, onWSOpen, onWSMessage, onWSClose, staticPaths, staticPathOptions, quiet) {
	.Call(`_tinyhttpserver_makePipeServer`, name, mask, onHeaders, onBodyData, onRequest, onWSOpen, onWSMessage, onWSClose, staticPaths, staticPathOptions, quiet)
}

stopServer_ <- function(handle) {
	invisible(.Call(`_tinyhttpserver_stopServer_`, handle))
}

getStaticPaths_ <- function(handle) {
	.Call(`_tinyhttpserver_getStaticPaths_`, handle)
}

setStaticPaths_ <- function(handle, sp) {
	.Call(`_tinyhttpserver_setStaticPaths_`, handle, sp)
}

removeStaticPaths_ <- function(handle, paths) {
	.Call(`_tinyhttpserver_removeStaticPaths_`, handle, paths)
}

getStaticPathOptions_ <- function(handle) {
	.Call(`_tinyhttpserver_getStaticPathOptions_`, handle)
}

setStaticPathOptions_ <- function(handle, opts) {
	.Call(`_tinyhttpserver_setStaticPathOptions_`, handle, opts)
}

base64encode <- function(x) {
	.Call(`_tinyhttpserver_base64encode`, x)
}
...
encodeURI <- function(value) {
	.Call(`_tinyhttpserver_encodeURI`, value)
}

#' @rdname encodeURI
#' @export
encodeURIComponent <- function(value) {
	.Call(`_tinyhttpserver_encodeURIComponent`, value)
}

#' @rdname encodeURI
#' @export
decodeURI <- function(value) {
	.Call(`_tinyhttpserver_decodeURI`, value)
}

#' @rdname encodeURI
#' @export
decodeURIComponent <- function(value) {
	.Call(`_tinyhttpserver_decodeURIComponent`, value)
}
...
ipFamily <- function(ip) {
	.Call(`_tinyhttpserver_ipFamily`, ip)
}

invokeCppCallback <- function(data, callback_xptr) {
	invisible(.Call(`_tinyhttpserver_invokeCppCallback`, data, callback_xptr))
}
...
getRNGState <- function() {
	invisible(.Call(`_tinyhttpserver_getRNGState`))
}

wsconn_address <- function(external_ptr) {
	.Call(`_tinyhttpserver_wsconn_address`, external_ptr)
}

log_level <- function(level) {
	.Call(`_tinyhttpserver_log_level`, level)
}
