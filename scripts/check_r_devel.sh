...
if [ -f "./tinyhttpserver.Rcheck/00install.out" ]; then
  cp "./tinyhttpserver.Rcheck/00install.out" "./check-r-devel/install-${std}-${compiler}-devel.log"
  echo "=== BEGIN 00install.out ==="
  cat "./tinyhttpserver.Rcheck/00install.out"
