#ifndef HTTPSERVER_01_THREAD_H
#define HTTPSERVER_01_THREAD_H
...
void register_main_thread() { __main_thread__ = uv_thread_self(); }

void register_background_thread() { __background_thread__ = uv_thread_self(); }
